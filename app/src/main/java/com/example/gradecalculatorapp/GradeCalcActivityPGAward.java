...
public class GradeCalcActivityPGAward extends AppCompatActivity {
    Button calcButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeInputs = new EditText[]{
                ...
                findViewById(R.id.gradeInput8),
                findViewById(R.id.gradeInput9)
        };
        ...
        creditInputs = new EditText[]{
                ...
                findViewById(R.id.creditInput8),
                findViewById(R.id.creditInput9)
        };
